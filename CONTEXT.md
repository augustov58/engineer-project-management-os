...
├── docs/
│   ├── adr/                  ← architecture decisions 0001-0030 (check Status lines)
...
| 3 | Site visit capture (voice, photos, stable issue IDs) | **Started** — issue #9 done; #10-#13 remain |

...
├── docs/
│   ├── adr/                  ← architecture decisions 0001-0031 (check Status lines)
...
| 3 | Site visit capture (voice, photos, stable issue IDs) | **Started** — issues #9 and #10 done; #11-#13 remain |

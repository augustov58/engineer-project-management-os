...
├── docs/
│   ├── adr/                  ← architecture decisions 0001-0032 (check Status lines)
...
| 3 | Site visit capture (voice, photos, stable issue IDs) | **Started** — issues #9, #10 and #11 done; #12 and #13 remain |
